...
function uploadFile(file){
    ...
    uploadTask.on('state_changed', (snapshot) => {
      ...
      console.log(error);
    	...
    	var httpsReference = storage.refFromURL('https://firebasestorage.googleapis.com/b/bucket/o/images%20' + file.name);
